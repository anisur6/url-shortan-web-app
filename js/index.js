...
form.addEventListener("submit", (e) => {
  ...
  async function shortenUrl(url) {
    try {
      ...
      newUrl.innerHTML = `
     <p style='font-size: 15px; font-weighht: bold; margin-right: 5px;'> ${data.result.short_link}</p>
     <button class="newUrl-btn" style='background-color: lightblue; font-weight: bold;' >Copy</button>
     `;
